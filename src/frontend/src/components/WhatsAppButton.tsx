...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed z-50 flex items-center justify-center rounded-full shadow-elevated transition-smooth hover:scale-110 hover:shadow-[0_12px_32px_rgba(37,211,102,0.4)]"
      style={{
        width: 56,
        height: 56,
